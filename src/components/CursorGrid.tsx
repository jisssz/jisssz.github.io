...
const hexToRgb = (hex: string): [number, number, number] => {
  ...
  if (Number.isNaN(num)) return [255, 90, 31];
...
export const CursorGrid: FC<CursorGridProps> = ({
  ...
  return (
    <div
      ref={containerRef}
      aria-hidden="true"
      className={`pointer-events-none fixed inset-0 z-[2] h-screen w-screen overflow-hidden ${className}`}
    >
