...
const drawLine = (
  ...
  let cursor = align === 'left' ? 0 : align === 'right' ? x * 2 - lineW : x - lineW / 2;
...
const buildTextCanvas = ({
  ...
  lines.forEach((line, index) =>
    drawLine(ctx, line, width / 2, startY + index * lineHeight, letterSpacing, props.align)
  );
...
const syncUniforms = (program: any, props: Required<WarpTextProps>) => {
